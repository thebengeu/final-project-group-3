...
/*┌──────────────────────────────────────────────────────────────────────────────────────────────────┐
  ...
  └──────────────────────────────────────────────────────────────────────────────────────────────────┘*/
    ...
    [NSTimer scheduledTimerWithTimeInterval:120 target:self selector:@selector(ensureAssociationsCount) userInfo:nil repeats:YES];
    
    NSLog(@"NTP service started.");
...
/*┌──────────────────────────────────────────────────────────────────────────────────────────────────┐
  ...
  └──────────────────────────────────────────────────────────────────────────────────────────────────┘*/
        ...
        if (ntpHostAddrs == nil) {
            NSLog(@"CFHostGetAddressing: no addresses resolved");
            CFRelease(ntpHostName);
...
- (void) ensureAssociationsCount
{
    if ([timeAssociations count] < 8){
        NSLog(@"Restarting NTP assoications (less than 8 assoications)");
        [self finishAssociations];
        [self startAssociations];
    } 
}
