...
//  Just poll regularly
static double pollIntervals[18] = {
    30.0,    30.0,    30.0,    30.0,    30.0,   60.0,
    60.0,   120.0,   240.0,   240.0,  240.0,   240.0,
...
/*┌──────────────────────────────────────────────────────────────────────────────────────────────────┐
  ...
  └──────────────────────────────────────────────────────────────────────────────────────────────────┘*/
    ...
    //NSLog(@"[%@] index=%i {%5.3f,%5.3f,%5.3f,%5.3f,%5.3f,%5.3f,%5.3f,%5.3f}", server,
...
/*┌──────────────────────────────────────────────────────────────────────────────────────────────────┐
  ...
  └──────────────────────────────────────────────────────────────────────────────────────────────────┘*/
    if (good > 0 || fail > 3) {
        ...
        //NSLog(@"[%@] index=%i {good: %i; fail: %i; none: %i} offset=%3.1f", server,
...
/*┌──────────────────────────────────────────────────────────────────────────────────────────────────┐
  ...
  └──────────────────────────────────────────────────────────────────────────────────────────────────┘*/
    ...
    if ([repeatingTimer timeInterval] != pollIntervals[pollingIntervalIndex]) {
        //NSLog(@"[%@] poll interval adusted: %3.1f >> %3.1f", server,
